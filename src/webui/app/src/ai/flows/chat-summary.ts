'use server';
/**
 * @fileOverview Summarizes the chat for quick review of key points and action items.
 *
...
const prompt = ai.definePrompt({
  ...
  Please provide a concise summary of the following chat history, highlighting key points and action items.
