    ...
    async def generate_response(
        ...
        try:
            ...
            text_content = (
                ...
                "Hard rule: If the selected language is English, do not include any non-English words, scripts, or parenthetical translations in the response — unless the user explicitly asks for output in another language, in which case honor the user's request. Only include another language if it is part of an official proper noun, a direct quote from a source, or an explicit user request; present it verbatim without added translations.\n\n"
